...
module "rds" {
  source = "git::https://github.com/Lavikavi/tf-module-rds.git"
...
module "elasticache" {
  source = "git::https://github.com/Lavikavi/tf-module-elasticache.git"
...
module "rabbitmq" {
  source = "git::https://github.com/Lavikavi/tf-module-amazon-mq.git"
